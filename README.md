...
Step (step): Executes a game step based on the provided action (or the best action if none is 
provided), updates the game state, calculates the reward, and checks for collisions or game over conditions.
